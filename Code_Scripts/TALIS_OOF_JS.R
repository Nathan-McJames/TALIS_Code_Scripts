...
#Create response variable: Job Satisfaction.
Y<-dfsmall$T3JOBSA

#Create treatment variable: 1 if teacher teaches out-of-field, 0 otherwise.
W<-ifelse((df$TT3G15A1==0 & df$TT3G15A2==1)|
          (df$TT3G15B1==0 & df$TT3G15B2==1)|
          (df$TT3G15C1==0 & df$TT3G15C2==1)|
          (df$TT3G15D1==0 & df$TT3G15D2==1)|
          (df$TT3G15E1==0 & df$TT3G15E2==1)|
          (df$TT3G15F1==0 & df$TT3G15F2==1)|
          (df$TT3G15G1==0 & df$TT3G15G2==1)|
          (df$TT3G15H1==0 & df$TT3G15H2==1)|
          (df$TT3G15I1==0 & df$TT3G15I2==1)|
          (df$TT3G15J1==0 & df$TT3G15J2==1)|
          (df$TT3G15K1==0 & df$TT3G15K2==1), 1, 0)
