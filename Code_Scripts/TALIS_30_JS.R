...
X<-as.matrix(one_hot(as.data.table(dfsmall[,-c(6:12, 42, 43, 56, 24)])))
cn<-colnames(X)
...
#Create treatment variable: 1 if teacher has >=30 students, 0 otherwise.
W<-ifelse(df$TT3G38>=30, 1, 0)
